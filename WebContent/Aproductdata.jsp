...
<thead>
  ...
  <tbody>
    <tr>
      ...
      <td class="table-success">${i.price}</td>
      <td class="table-success">${i.qty}</td>
      <td class="table-success"><img src=${i.img} class=tiny></td>

      <td class="table-success"><a href="Aproduct.jsp"><img src="images/add.png"></a>
      
      <a href="updatepro.jsp?update=${i.productId}"><img src="images/edit.png"></a>
      
     <a href="DeleteProduct?productId=${i.productId}"><img src="images/delete.png"></a> </td>
