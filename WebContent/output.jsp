...
<c:forEach var="i" items="${list}">
  ...
  <tbody>
    <tr>
      ...
      <td class="table-success">${i.firstname}</td>
      <td class="table-success">${i.lastname}</td>
      <td class="table-success">${i.username}</td>
      <td class="table-success">${i.password}</td>
      ...
      <a href="DeleteUser?del=${i.username}"><img src="images/delete.png"></a></td>
